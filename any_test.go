...
func TestEnvAny(t *testing.T) {
	...
	t.Setenv("SOME_INT", "12345")
	t.Setenv("SOME_TRUE", "true")
	t.Setenv("SOME_FALSE", "false")
	...
	testCases := []struct {
		...
		{
			Input:    NewEnvAnyVariable("SOME_INT"),
			Expected: int64(12345),
		},
		{
			Input:    NewEnvAnyVariable("SOME_TRUE"),
			Expected: true,
		},
		{
			Input:    NewEnvAnyVariable("SOME_FALSE"),
			Expected: false,
		},
		{
			Input:    EnvAny{},
